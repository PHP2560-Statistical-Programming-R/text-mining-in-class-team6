...
transcripts_bing %>%
  ...
  geom_density_ridges(aes(x = Prop_Negative, fill = "Negative"), alpha = .7, rel_min_height = .03, scale = .95, na.rm = TRUE)+
  geom_density_ridges(aes(fill = "Positive"), alpha = .7, rel_min_height = .03, scale = .95, na.rm = TRUE) +
