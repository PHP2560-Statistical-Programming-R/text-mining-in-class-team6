...
bing_by_year = bing_by_year %>% inner_join(tagsdata, wt = year) %>% rename(yeartoptag = tag)
...
From the chart above, there does seem to be a trend of decreasing positivity in TED talks over time. Three out of four times, when culture is the top tag of the year, the proportion of sentiment words seems to sharply decrease. To investigate this further, we looked to see if there was a difference in sentiment between talks that had a "culture" tag and talks that had a "technology" tag.
